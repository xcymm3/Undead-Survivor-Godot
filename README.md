...
- WASD 移动、±85° 俯仰、跳跃、空中转向、沿墙滑动、僵尸阻挡、落水扣 10 血并回出生点。
...
首波 9 只。第 1～6、7～8、9～11、12 波以后分别每波增加 6、5、4、3 只。生命值为 100；僵尸每次攻击造成 10 点伤害。落水会扣血回出生点，只有生命耗尽才失败。以当前源码规则为准，原 README 中“落水直接失败”等旧描述未沿用。
