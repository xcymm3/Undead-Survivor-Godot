...
test('weapon poses without first-person hands and remote crouch visual evidence', async ({ page }, info) => {
  const errors = [];
  ...
  for (const [name, pose] of poses) {
    ...
    // All guns retain weapon-only presentation without first-person arms.
