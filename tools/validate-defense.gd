...
func run() -> void:
	...
	var expected_normal_budgets := [52,83,111,138,162,184,205,223,239,253]
	...
	check(actual_normal_budgets == expected_normal_budgets and actual_normal_budgets.reduce(func(total, value): return total+value,0) == 1650 and normal_rosters_spend_exactly,"Normal defense uses the rebalanced 1650-point curve exactly")
