...
const FINAL_ENTRIES = [Vector2(-14,-45),Vector2(-14,-52),Vector2(16,-40),Vector2(29,-54),Vector2(26,-29),Vector2(-26,-44),Vector2(-12,-60),Vector2(-8,-64),Vector2(-3,-65),Vector2(23,-63)]
const HOLDOUT_BUDGET = 14
const HOLDOUT_DUO_BUDGET = 56
const DUO_REINFORCEMENT_SCALE = 2.0
const DUO_BURST_SIZE = 12
const WOODS_BUDGET = 30
const TIMER_BUDGET = 24
const TIMER_SOLO_BUDGET = 30
const TIMER_INTERVAL = 60.0
const GUARDS = []
...
const ZONES = [
	{"id":"street","rect":Rect2(-28,34,56,24),"budget":36,"kinds":["cone","imp"]},
	{"id":"shop","rect":Rect2(-28,5,55,26),"budget":36,"kinds":["cone","bucket","imp","shield"]},
	{"id":"woods","rect":Rect2(-29,-29,58,30),"budget":81,"kinds":["cone","bucket","imp","shield","berserker"]},
	{"id":"approach","rect":Rect2(-28,-51,56,19),"budget":36,"kinds":["berserker","imp","bucket","cone","shield"]}]
