...
func _ready() -> void:
	for cue in ["shove","shove-hit","enemy-windup","enemy-impact","enemy-miss","grenade-explosion","campaign-winch","campaign-horde","campaign-gate","music","gun","flame","axe","reload","hurt","failure","death-0","death-1","death-2","cone-false","cone-true","bucket-false","bucket-true","shield-false","shield-true","football-false","football-true"]:
